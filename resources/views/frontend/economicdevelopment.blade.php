							...
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><!--<span class="promo-primary__pre-title">Helpo</span>-->
										<h1 class="promo-primary__title"><span>Economic Development</span> <span></span></h1>
									</div>
								</div>
							</div>
						</div>
				...
				<section class="section causes-inner">
					<div class="container">
						...
						<div class="col-md-8 offset-md-2 col-lg-12 offset-lg-0">
                            @foreach ($economicdevelopment as $economic)
								<div class="causes-item causes-item--style-3">
									<div class="causes-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="causes-item__img"><img class="img--bg" src="{{asset('frontend/img/project/economicdevelopment')}}/{{$economic->photo}}" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												...
												<div class="causes-item__top">
													<h6 class="causes-item__title"> <a href="#">{{$economic->project_name}}</a></h6>
													<p>{{$economic->project_desp}}
