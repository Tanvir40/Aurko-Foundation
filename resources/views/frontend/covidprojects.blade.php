							...
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><!--<span class="promo-primary__pre-title">Helpo</span>-->
										<h1 class="promo-primary__title"><span>Covid-19 Projects</span> <span></span></h1>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="causes-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="causes-item__img"><img class="img--bg" src="{{asset('frontend/img/project/covid')}}/{{$covid->photo}}" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												...
												<div class="causes-item__top">
													<h6 class="causes-item__title"> <a href="#">{{$covid->project_name}}</a></h6>
													<p>{{$covid->project_desp}}
