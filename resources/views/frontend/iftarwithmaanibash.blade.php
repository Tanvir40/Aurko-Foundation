							...
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item">
										<h1 class="promo-primary__title"><span> Iftar With Maa Nibash</span></h1>
									</div>
								</div>
							</div>
						</div>
				...
				<section class="section blog background--brown"><img class="blog__bg" src="{{asset('frontend/img/events_inner-bg.png')}}" alt="img"/>
					<div class="container">
						<div class="row offset-margin">
							...
							@foreach ($iftarwithmaanibash as $photo)
							<div class="col-md-6 col-lg-5 col-xl-4">
								<div class="blog-item blog-item--style-1">
									<div class="blog-item__img">
									<a href="{{asset('frontend/img/PhotoGallery/iftarwithmaanibash')}}/{{$photo->photo}}" data-fancybox="gallery">
									<img class="img--bg" src="{{asset('frontend/img/PhotoGallery/iftarwithmaanibash')}}/{{$photo->photo}}" alt="img"/>
                                        </a>
									</div>
