        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{asset('allslider')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Slider</p>
                </a>
              </li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{asset('newaddedphotogallery')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Photo</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{asset('allphotos')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Photo</p>
                </a>
              </li>
          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Inception Published </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

              @foreach($inceptionadded as $inceptionadded)
              <form action="{{URL('/ourinceptionadded/updatesaveinception')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}            
                                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Inception First Column</label>
                    <input type="text" value="{{$inceptionadded->inception_first_column}}" class="form-control" id="exampleInputEmail1" placeholder="Enter First Column ">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Inception Second Column</label>
                    <input type="text" value="{{$inceptionadded->inception_second_column}}" class="form-control" id="exampleInputEmail1" placeholder="Enter Second Column">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Inception Description</label>
                    <input type="text" value="{{$inceptionadded->descriptions}}" class="form-control" id="exampleInputEmail1" placeholder="Enter More Description">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Image</label>
                    <div class="input-group">
                      <div><img src="../public/frontend/img/{{$inceptionadded->image}}" style="height: 35px;width: 50px"></div>
