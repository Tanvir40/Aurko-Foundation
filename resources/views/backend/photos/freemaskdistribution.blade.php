            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h2>Add <b>freemaskdistribution Photo</b></h2>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($freemaskdistribution as $key=>$mask)
                                <tr>
                                        <td data-title="SL">{{$key+1}}</td>
                                        <td data-title="Small Text">{{$mask->title}}</td>
                                        <td data-title="Carousel Image">
                                            <img style="height:48px" src="{{asset('frontend/img/PhotoGallery/freemaskdistribution')}}/{{$mask->photo}}" alt="">
                                        </td>
