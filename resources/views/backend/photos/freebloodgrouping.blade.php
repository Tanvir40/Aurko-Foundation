            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h2>Add <b>free blood grouping Photo</b></h2>
                        </div>
                    ...
                    <div class="col-md-10 m-auto">
                        ...
                        <form action="{{route('freebloodgrouping.save')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($freebloodgrouping as $key=>$mask)
                                <tr>
                                    ...
                                    <td data-title="Action">
                                        <button type="button" name="{{route('freebloodgrouping.delete'
