            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h2>Add <b>eid distribution gift 2022 Photo</b></h2>
                        </div>
                    ...
                    <div class="col-md-10 m-auto">
                        ...
                        <form action="{{route('eiddistributiongift2022.save')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($eiddistributiongift2022 as $key=>$mask)
                                <tr>
                                        <td data-title="SL">{{$key+1}}</td>
                                        <td data-title="Small Text">{{$mask->title}}</td>
                                        <td data-title="Carousel Image">
                                            <img style="height:48px" src="{{asset('frontend/img/PhotoGallery/eiddistributiongift2022')}}/{{$mask->photo}}" alt="">
                                        </td>
                                    <td>{{$mask->created_at->format('d-m-Y H-i A')}}</td>
                                    <td data-title="Action">
                                        <button type="button" name="{{route('eiddistributiongift2022.delete'
